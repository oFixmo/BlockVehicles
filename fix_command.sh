# Update VehicleCommand.java with the correct array indexes
...
git add .
git commit -m "Fix VehicleCommand argument index errors"
git push

echo "=== BUILD SUCCESSFUL! BlockVehicles.jar is ready ==="
